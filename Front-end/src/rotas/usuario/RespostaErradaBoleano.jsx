...
import { PerguntasBoleano } from '../usuario/PerguntasBoleano'; // Importando as perguntas booleanas

export default function RespostaErradaBoleano({ location }) {
  ...
  return (
    <div className="w-screen h-screen relative">
      <BackgroundLayout backgroundImage={`url('./src/assets/img_fundo/fundo7.png\')`}>
